...
Rails.application.configure do
  ...
  # This prevents self-redirect loops when TLS is terminated before Rails.
  config.assume_ssl = true

  # Force all access to the app over SSL, use Strict-Transport-Security, and use secure cookies.
  config.force_ssl = true

  # Skip http-to-https redirect for the default health check endpoint so Kamal and
  # load balancers can probe the app during rollout without a redirect loop.
